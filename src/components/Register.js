                                            ...
                                            <Row xs="3">
                                                <Col className="ps-0 pe-1">
                                                    <Input
                                                        ...
                                                        required
                                                    >
                                                        { years.map(year => (<option key={ year } style={{ color: 'rgba(117,122,129)' }}>{ year }</option>)) }
                                                    </Input>
                                                </Col>
                                                ...
                                                <Col className="px-1">
                                                    <Input
                                                        ...
                                                        required
                                                    >
                                                        { months.map(month => (<option key={ month } style={{ color: 'rgba(117,122,129)' }}>{ month }</option>)) }
                                                    </Input>
                                                </Col>
                                                ...
                                                <Col className="ps-1 pe-0">
                                                    ...
                                                    >
                                                        { Array.from({ length: 31 }, (_, i) => i + 1).map(
                                                            day => (<option key={ day } style={{ color: 'rgba(117,122,129)' }}>{ day }</option>)
                                                        ) }
                                                    </Input>
                                                </Col>
                                            </Row>
